...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Helath services Manager</title>
		...
		<nav>
			...
			<div class="menu">
				<ul>
					...
					<li><a href="../system/index.php">Sytem Administartors/Record Manager</a></li>
					<li><a href="index.php">Health Services Manager</a></li>
				</ul>
			</div>
		</nav>
		<div class="log-main">
			<div class="log">
			<h3>Helath Services Management Login</h3>
